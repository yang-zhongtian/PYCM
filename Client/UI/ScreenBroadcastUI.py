...
class Ui_ScreenBroadcast(object):
    def setupUi(self, ScreenBroadcast):
        ...
        self.screen_display = QtWidgets.QFrame(self.screen_widget)
        self.screen_display.setGeometry(QtCore.QRect(0, 0, 231, 151))
        self.screen_display.setAutoFillBackground(True)
        self.screen_display.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.screen_display.setFrameShadow(QtWidgets.QFrame.Raised)
