...
class Ui_DashboardForm(object):
    def setupUi(self, DashboardForm):
        ...
        self.toggle_black_screen = QtWidgets.QPushButton(self.frame_header)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.toggle_black_screen.sizePolicy().hasHeightForWidth())
        self.toggle_black_screen.setSizePolicy(sizePolicy)
        self.toggle_black_screen.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.toggle_black_screen.setFont(font)
        self.toggle_black_screen.setObjectName("toggle_black_screen")
        self.horizontalLayout.addWidget(self.toggle_black_screen)
        ...
        self.remote_operation_menu = QtWidgets.QMenu(self.menubar)
        self.remote_operation_menu.setObjectName("remote_operation_menu")
        ...
        self.remote_operation_menu.addAction(self.remote_shutdown_menu)
        self.remote_operation_menu.addAction(self.remote_reboot_menu)
        self.menubar.addAction(self.menu.menuAction())
        self.menubar.addAction(self.remote_operation_menu.menuAction())
    ...
    def retranslateUi(self, DashboardForm):
        ...
        self.toggle_black_screen.setText(_translate("DashboardForm", "黑屏/解除"))
        ...
        self.remote_operation_menu.setTitle(_translate("DashboardForm", "远程命令"))
