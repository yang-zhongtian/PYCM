...
"")
    ...
    def retranslateUi(self, DashboardForm):
        ...
        self.client_rename.setToolTip(_translate("DashboardForm", "重命名客户端"))
import Resources_rc
